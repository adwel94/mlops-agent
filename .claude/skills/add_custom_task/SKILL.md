...
1. **`scripts/custom_envs.py`** — `@register_env("<Id>-v1", ...)` 환경 클래스. 계약을 반드시 충족:
...
```
C:\Users\hun41\miniconda3\envs\maniskill\python.exe scripts\validate_custom_task.py <Id>-v1 [--count 3]
```
